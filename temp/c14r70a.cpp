...
int main() {
    ...
    vector<int> testTargets = {7, 12, 15}; // Targets to search for
    vector<int> expectedResults = {3, 5, 2}; // Expected indices (0-based)

    bool allTestsPassed = true; // Flag to track overall test result
    ...
    cout << (allTestsPassed ? "true" : "false") << endl;
